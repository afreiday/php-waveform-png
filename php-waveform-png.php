<?php
  ...
  if (isset($_FILES["mp3"])) {
    ...
    if ($background == "") {
      ...
      imagefilledrectangle($img, 0, 0, (int) ($data_size / DETAIL), $height, imagecolorallocate($img, $r, $g, $b));
    }
    ...
    if ($width) {
      ...
      // copy to resized
      imagecopyresampled($rimg, $img, 0, 0, 0, 0, $width, $height, $data_size / DETAIL, $height);
